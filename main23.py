...
"""
# 正式开始项目,处理标准 HWDB2.0, 使用attention进行处理
import torch
...
logging.config.fileConfig('logging.conf', defaults={
                          'logfilename': 'log08.txt'})

# create logger
logger = logging.getLogger('nice')

DATAPATH = "C:\\Users\\weihuan\\Desktop\\data"
SAVE_MODLE_NAME = '03-encoder_attention_hwdb.pt'
SAVE_MODLE_NAME2 = '03-decoder_attention_hwdb.pt'
...
def plot_loss(logname, savename, start=0):
    ...
    ax.plot(y, label='hwdb 中文识别 attention loss')
