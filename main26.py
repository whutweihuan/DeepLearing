...
# 本程序是 GUi 程序，能够用鼠标书写输入文字之后进行转化为 png 图片
...
class MainWindow(QWidget):
    ...
    # 将按键按下信号与画板清空函数相关联
        ...
        self.__btn_Recognize = QPushButton("识别图像")
        self.__btn_Recognize.setParent(self)
        self.__btn_Recognize.clicked.connect(self.on_btn_Recognize)
        ...
        self.__spinBox_penThickness.setValue(1)  # 默认粗细为10
    ...
    def on_btn_Recognize(self):
        # print('hello world!')
        image = self.__paintBoard.GetContentAsQImage()
        image.save('test.png')
        main23.testMyImage('test.png')
